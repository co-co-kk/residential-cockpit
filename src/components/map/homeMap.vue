<template>
  ...
  ></div>
    <div class="note_class">
      <div class="text-[28px]  font-400 ml-[18px]">
        项目数量
      </div>
      <div class=" flex  ml-[18px]">
        <span class="w-[15px] h-[15px] m-[10px] bg-[#864753] text-[20px]   border_r"></span>120以上
      </div>
      <div class=" flex  ml-[18px]">
        <span class="w-[15px] h-[15px] m-[10px] bg-[#977951] text-[20px]  border_r"></span>91-120
      </div>
      <div class=" flex  ml-[18px]">
        <span class="w-[15px] h-[15px] m-[10px] bg-[#306F5A] text-[20px]  border_r"></span> 61-90
      </div>
      <div class=" flex  ml-[18px]">
        <span class="w-[15px] h-[15px] m-[10px] bg-[#356B9C] text-[20px]  border_r"></span> 31-60
      </div>
      <div class=" flex  ml-[18px]">
        <span class="w-[15px] h-[15px] m-[10px] bg-[#999999] text-[20px]  border_r"></span> 0-30
      </div>
    </div>
  
    <div id="popup6" class="ol-popup6" v-show="informationShow" :style="{
      borderColor:
...
const init2DMap = () => {
  ...
  map.value = new Map({
    layers: [
      new TileLayer({
        source: new WMTS({
          url: "http://172.30.41.194:20035/agserver/gwc/service/wmts",
